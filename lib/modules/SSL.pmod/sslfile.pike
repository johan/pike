...
//!
//! It will only be called if the connection is closed cleanly with
//! the proper messages. Any other way of closing the it is considered
//! an error to avoid truncation attacks.
{
